...
func (b *pluginBroker) deliverCodex(ctx context.Context, c *pluginConnection, payload map[string]any) error {
	...
	mention := payload["kind"] == "connection_notice" || payload["kind"] == "message" || payload["kind"] == "mention" || payload["kind"] == "join_request" || payload["kind"] == "approval_needed" || payload["kind"] == "needs_attention"
